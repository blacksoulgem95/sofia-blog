<div class="flex justify-center items-center bg-black/70 border-4 border-[var(--color-trans-light-blue)] p-4 md:p-8 md:px-12 my-12 shadow-search lg:-mx-12">
    <form action="" method="post" class="w-full max-w-3xl">
        <div class="flex flex-col items-center w-full gap-3 md:gap-4">
            ...
            <div class="text-sm text-[var(--color-trans-white)]">Need forms? Try <a href="https://fieldgoal.io/" class="underline text-[var(--color-trans-light-blue)] hover:text-[var(--color-trans-pink)]" target="_blank">FieldGoal</a></div>
        </div>
    </form>
</div>
