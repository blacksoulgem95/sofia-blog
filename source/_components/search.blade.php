<div x-data="{
     ...
     x-cloak
     class="flex flex-1 justify-center items-center text-right px-4 bg-transparent w-full lg:mx-3"
>
    <div
    ...
    >
        ...
        <div class="relative">
            <i class="nes-icon coin is-small h-4 w-4 absolute left-2 ml-2 top-1/2 -translate-y-1/2 pl-3 text-gray-400"></i>
            <input
                    id="search"
                    x-model="query"
                    x-ref="search"
                    class="block h-10 w-full lg:w-1/2 lg:focus:w-full bg-gray-800 border-2 border-[var(--color-trans-pink)] focus:border-[var(--color-trans-light-blue)] outline-none cursor-pointer text-[var(--color-trans-white)] pl-10 pr-4 pb-0 pt-px transition-all duration-200 ease-out placeholder-[var(--color-trans-light-blue)]"
                    :class="{ 'rounded-none': query, 'rounded-none': !query }"
